		...
		<body>
			<div class="card text-center" style="margin: 30px 70px;">
				<div class="card-header">
			    	...
			    	<h6 class="card-subtitle mb-2 text-muted">Opération de la modification</h6>
		  		</div>
				<div class="card-body">
					<p class="card-text text-success alert alert-info">La modification est terminée avec succées</p>
				</div>
			</div>
